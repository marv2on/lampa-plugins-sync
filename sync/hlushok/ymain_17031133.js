(function () {
    ...
    const DEFAULT_ROWS_SETTINGS =[
        { id: 'ym_row_history', title: 'Р†СЃС‚РѕСЂС–СЏ РїРµСЂРµРіР»СЏРґСѓ', defOrder: '1', default: true },
        { id: 'ym_row_movies_new', title: 'РќРѕРІРёРЅРєРё С„С–Р»СЊРјС–РІ', defOrder: '2', default: true },
        { id: 'ym_row_series_new', title: 'РќРѕРІРёРЅРєРё СЃРµСЂС–Р°Р»С–РІ', defOrder: '3', default: true },
        { id: 'ym_row_collections', title: 'РџС–РґР±С–СЂРєРё KinoBaza', defOrder: '4', default: true },
        { id: 'ym_row_kinobaza', title: 'РќРѕРІРёРЅРєРё РЎС‚СЂС–РјС–РЅРіС–РІ UA', defOrder: '5', default: true },
        { id: 'ym_row_community', title: 'Р—РЅР°С…С–РґРєРё СЃРїС–Р»СЊРЅРѕС‚Рё LME', defOrder: '6', default: true },
        { id: 'ym_row_movies_watch', title: 'РџРѕРїСѓР»СЏСЂРЅС– С„С–Р»СЊРјРё', defOrder: '7', default: true },
        { id: 'ym_row_series_pop', title: 'РџРѕРїСѓР»СЏСЂРЅС– СЃРµСЂС–Р°Р»Рё', defOrder: '8', default: true },
        { id: 'ym_row_random', title: 'Р’РёРїР°РґРєРѕРІР° РїС–РґР±С–СЂРєР°', defOrder: '9', default: true }
    ];
    ...
    async function searchTmdbByTitleAndYear(title, year) {
        ...
        try {
            ...
            if (data && data.results && data.results.length > 0) {
                // РЎС‚СЂРѕРіР° РїРµСЂРµРІС–СЂРєР° СЂРѕРєСѓ (РґРѕРїСѓСЃРєР°С”РјРѕ РїРѕС…РёР±РєСѓ +-1 СЂС–Рє РґР»СЏ СЂРµРіС–РѕРЅР°Р»СЊРЅРёС… СЂРµР»С–Р·С–РІ)
    ...
    function fetchLogo(movie, itemElement) {
        ...
        // Р¤СѓРЅРєС†С–СЏ РґР»СЏ РІС–РґРѕР±СЂР°Р¶РµРЅРЅСЏ С‚С–Р»СЊРєРё С‚РµРєСЃС‚Сѓ Р·Р°РјС–СЃС‚СЊ РєР°СЂС‚РёРЅРєРё
        ...
        // РЇРєС‰Рѕ РІ РЅР°Р»Р°С€С‚СѓРІР°РЅРЅСЏС… РѕР±СЂР°РЅРѕ С‚С–Р»СЊРєРё С‚РµРєСЃС‚, РІС–РґСЂР°Р·Сѓ СЃС‚Р°РІРёРјРѕ С‚РµРєСЃС‚
    ...
    // РљР°СЂС‚РєР° "РћР±СЂР°РЅРµ", СЏРєР° РґРѕРґР°С”С‚СЊСЃСЏ РЅР° РїРѕС‡Р°С‚РѕРє С–СЃС‚РѕСЂС–С— РїРµСЂРµРіР»СЏРґС–РІ
    function makeFavoriteCardItem(bgUrl) {
        return {
            ...
            params: {
                createInstance: function () {
                    return Lampa.Maker.make('Card', { title: 'РћР±СЂР°РЅРµ' }, function (module) { return module.only('Card', 'Callback'); });
                },
                emit: {
                    onCreate: function () {
                        var item = $(this.html);
                        ...
                        view.append('<div style="position: absolute; top:0; left:0; right:0; bottom:0; display:flex; flex-direction: column; align-items:center; justify-content:center; z-index: 2; padding: 10%; box-sizing: border-box;">' +
                            ...
                            '<div style="font-size: 1.1em; font-weight: bold; text-shadow: 0px 2px 4px rgba(0,0,0,0.8); text-align: center; color: #fff;">РћР±СЂР°РЅРµ</div>' +
                            '</div>');
                    },
                    onlyEnter: function () {
                        Lampa.Activity.push({
    ...
    function createSettings() {
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { name: 'РљР°СЂС‚РєР° "РћР±СЂР°РЅРµ" РІ С–СЃС‚РѕСЂС–С—', description: 'РџРѕРєР°Р·СѓРІР°С‚Рё С€РІРёРґРєРёР№ РґРѕСЃС‚СѓРї РґРѕ РћР±СЂР°РЅРѕРіРѕ РїРµСЂС€РёРј Сѓ СЂСЏРґРєСѓ С–СЃС‚РѕСЂС–С—' }
        });
        ...
        var langValues = {
            ...
            'text_uk': 'Р—Р°РІР¶РґРё С‚РµРєСЃС‚ (РЈРєСЂ)',
            'text_en': 'Р—Р°РІР¶РґРё С‚РµРєСЃС‚ (РђРЅРіР»)'
        };
        Lampa.SettingsApi.addParam({
            component: 'ymainpage',
    ...
    function overrideApi() {
        Lampa.Api.sources.tmdb.main = function (params, oncomplite, onerror) {
            var rowDefs =[
                ...
                { id: 'ym_row_movies_new', defOrder: 2, type: 'uas', url: 'uas_movies_new', loadUrl: 'https://uaserials.com/films/p/', title: 'РќРѕРІРёРЅРєРё С„С–Р»СЊРјС–РІ', icon: 'https://upload.wikimedia.org/wikipedia/commons/5/51/Ukraine_film_clapperboard.svg' },
                ...
                { id: 'ym_row_collections', defOrder: 4, type: 'kinobaza_collections', url: 'kinobaza_collections_list', loadUrl: 'https://kinobaza.com.ua/lists?order_by=popular&page=', title: 'РџС–РґР±С–СЂРєРё KinoBaza', icon: 'https://upload.wikimedia.org/wikipedia/commons/e/ef/Film-award-stub.svg' },
                { id: 'ym_row_kinobaza', defOrder: 5, type: 'kinobaza', url: 'kinobaza_streaming', loadUrl: 'https://kinobaza.com.ua/online?order_by=date_desc&rating=1&rating_max=10&imdb_rating=1&imdb_rating_max=10&itunes_audio=1&rakuten_audio=1&netflix_audio=1&playmarket_audio=1&takflix_audio=1&sweet_audio=1&primevideo_audio=1&per_page=30&translated=has_ukr_audio&page=', title: 'РќРѕРІРёРЅРєРё РЎС‚СЂС–РјС–РЅРіС–РІ UA', icon: 'https://upload.wikimedia.org/wikipedia/commons/a/a5/Netflix_meaningful_logo.svg' },
                { id: 'ym_row_community', defOrder: 6, type: 'community', url: 'uas_community', title: 'Р—РЅР°С…С–РґРєРё СЃРїС–Р»СЊРЅРѕС‚Рё LME', icon: 'https://upload.wikimedia.org/wikipedia/commons/b/b2/Anime_eye_film.png' },
                { id: 'ym_row_movies_watch', defOrder: 7, type: 'uas', url: 'uas_movies_pop', loadUrl: 'https://uaserials.my/filmss/w/', title: 'РџРѕРїСѓР»СЏСЂРЅС– С„С–Р»СЊРјРё', icon: 'https://upload.wikimedia.org/wikipedia/commons/7/7e/Filmreel-icon.svg' },
                { id: 'ym_row_series_pop', defOrder: 8, type: 'uas', url: 'uas_series_pop', loadUrl: 'https://uaserials.com/series/w/', title: 'РџРѕРїСѓР»СЏСЂРЅС– СЃРµСЂС–Р°Р»Рё', icon: 'https://upload.wikimedia.org/wikipedia/commons/f/f6/Tvfilm.svg' },
                { id: 'ym_row_random', defOrder: 9, type: 'random', url: '', title: 'Р’РёРїР°РґРєРѕРІР° РїС–РґР±С–СЂРєР°', icon: 'https://upload.wikimedia.org/wikipedia/commons/a/a3/Magicfilm_icon.svg' }
            ];
