                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        if (data && data.trailer && data.trailer.playback) {
                                            ...
                                            if (video_url) {
                                                var final_url = use_proxy ? "https://cors.bwa.workers.dev/" + video_url : video_url;
                                ...
                                success: function (data) {
                                    ...
                                    if (data && data.trailer && data.trailer.playback) {
                                        ...
                                        if (video_url) {
                                            tr = {
                                                type: 'imdb_video',
                                                url: use_proxy ? "https://cors.bwa.workers.dev/" + video_url : video_url,
                                                id: imdb_id,
                                                startTime: 10
                                            };
                                        }
