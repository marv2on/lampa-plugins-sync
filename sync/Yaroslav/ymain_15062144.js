(function () {
    ...
    function normalizeMovieData(movie) {
        if (movie) {
            ...
            if (!movie.img && movie.poster_path) {
                ...
                movie.img = PROXIES[0] + Lampa.TMDB.image('t/p/' + quality + movie.poster_path);
            }
        }
        return movie;
    }
    ...
    function updateDynamicStyles() {
        var nativeMode = Lampa.Storage.get('uas_native_cards_mode') === true;
        if (nativeMode) {
            document.body.classList.add('uas-native-cards-mode');
        } else {
            document.body.classList.remove('uas-native-cards-mode');
        }
    ...
    function createSettings() {
        ...
        Lampa.Settings.listener.follow('change', function(e) {
            var keys = ['uas_alt_design_type', 'uas_alt_badge_size', 'uas_text_hide', 'uas_text_align', 'uas_text_desc_align', 'uas_text_title_size', 'uas_text_desc_size', 'uas_bg_mode', 'uas_native_cards_mode', 'ym_row_title_size'];
    ...
    function start() {
        ...
        style.innerHTML = `
            ...
            /* Базовий захищений клас для наших кастомних карток */
            .uas-custom-card {
            ...
            /* Кастомна кнопка підбірки (ДИНАМІЧНИЙ РОЗМІР + ЦЕНТРУВАННЯ + МАКСИМУМ 2 РЯДКИ) */
        ...
        CardMaker.Card.onVisible = function () {
            ...
            var isSpecialCard = html.classList.contains('uas-custom-card') || html.classList.contains('card--title-btn') || html.classList.contains('card--collection-btn') || data.is_title_btn || data.is_collection_btn;
            var nativeMode = Lampa.Storage.get('uas_native_cards_mode') === true;
