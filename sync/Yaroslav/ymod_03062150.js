(function () {
    ...
    var styles = `
        ...
        /* Успадкування приховання кнопок від сторонніх плагінів (наприклад buttons.js) */
        ...
        /* Інтеграція кнопок плагіну Bandera (ua-sites-container / ua-btn-item) */
        ...
        body.ymod-buttons-apple .ua-btn-item {
            ...
            font-size: inherit !important; /* Перевизначення розмірів Bandera */
        }
   ...
   function renderStudiosTitle(render, title, movie) {
        ...
        var wrap = $('<div class="plugin-uk-title-combined" style="margin-top: 10px; margin-bottom: 5px; text-align: left; width: 100%; display: flex; flex-direction: column; align-items: flex-start;"><div class="' + containerClass + '" style="display: flex; align-items: center; ' + wrapStyle + '">' + html + '</div></div>');
    ...
    function createSettings() {
        ...
        addSelect('ym_ratings', 'omdb_rating_gap', 'Відстань між рейтингами', '', { '-1em': '-1em', '-0.8em': '-0.8em', '-0.5em': '-0.5em', '-0.2em': '-0.2em', '0px': '0', '0.2em': '0.2em', '0.5em': '0.5em (Стандарт)', '1em': '1em', '1.5em': '1.5em', '2em': '2em' }, '0.5em');
        ...
        addSelect('ym_studios', "studio_logo_gap", "Відступ між лого", "", { '-1em': '-1em', '-0.8em': '-0.8em', '-0.5em': '-0.5em', '-0.2em': '-0.2em', '0px':'0', '0.2em':'0.2em', '0.5em':'0.5em', '1.0em':'1.0em', '1.2em':'1.2em', '1.5em':'1.5em', '2.0em':'2.0em' }, '0.2em');
        ...
        addSelect('ym_uator', 'uator_gap', 'Відстань між значками', '', { '-1em': '-1em', '-0.8em': '-0.8em', '-0.5em': '-0.5em', '-0.2em': '-0.2em', '0px': '0', '0.2em': '0.2em', '0.45em': '0.45em (Стандарт)', '0.8em': '0.8em', '1em': '1em' }, '0.45em');
