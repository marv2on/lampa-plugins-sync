(function () {
    ...
    function makeHistoryCardItem(movie) {
        movie = normalizeMovieData(movie, true); 
        movie.is_history_card = true; 
        return {
