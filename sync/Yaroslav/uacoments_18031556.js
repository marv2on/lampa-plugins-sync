(function() {
    ...
    var UaCommentViewer = {
        ...
        keydownHandler: null,
        isClosing: false, // Захист від подвійних кліків
        ...
        updateUI: function() {
            ...
            // Додатковий захист від можливих посилань (щоб уникнути 404 помилки)
    ...
    UaCommentItem.prototype.create = function() {
        try {
            ...
            root.on('hover:enter click', function(e) {
                // Блокування подвійних натисків, щоб не викликати 404
                e.preventDefault(); e.stopPropagation();
    ...
    function InlineComments() {
        ...
        this.init = function() {
            ...
            style.innerHTML = 
                ...
                /* Слайдер: прибрано gap для кращої сумісності зі старими ТВ, елементи відштовхуються через margin-right */
                ...
                /* Картка коментаря (простий фон за замовчуванням, margin-right замість gap) */
                ...
                /* Спрощена анімація без фільтрів та маштабування (для ТВ) */
                "@keyframes uacomAppear{0%{opacity:0;transform:translateY(30px)}100%{opacity:1;transform:translateY(0)}}\n" +
                
                /* Оверлей та Вікно без сучасних тегів inset/backdrop-filter за замовчуванням */
                ...
                /* Ефекти тільки для сучасних девайсів */
                ...
                /* Хедер модального вікна (прибрано gap) */
