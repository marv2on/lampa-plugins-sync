                ...
                if (useUaSerials) {
                    try {
                        ...
                        var usTimeout = setTimeout(function() { 
                            if (!usCompleted) { usCompleted = true; data.us = []; finish(); } 
                        }, 15000); 

                        // Беремо англійську/оригінальну назву подібно до tort8.js
                        ...
                        if (!usSearchTitle) {
                            ...
                            network.req(searchUrl, function(html) {
                                ...
                                // Шукаємо кандидати, як в tort8.js (a[href] з патерном)
                                ...
                                var checkUsLink = function() {
                                    ...
                                    network.req(targetUrl, function(pageHtml) {
                                        ...
                                        // Перевіряємо збіг по IMDB прямісінько в коді знайденої сторінки
                                        if (imdbId) {
                                            ...
                                            // Якщо IMDB ID немає, беремо першого-ліпшого кандидата
                                            matchFound = true;
                                        }

                                        if (matchFound) {
                                            // Витягуємо коментарі зі знайденої сторінки
